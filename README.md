...
- Looks if theres any squares with enough flags to clear adjacent squares
- Looks more in depth at squares to find confirmed flags and free squares that avoided the first test
...
The reason for the resting between moves is because the animations of minesweeper get in the way of the screenshot. **It can go faster but with less accuracy becuase the animations get in the way**.  
